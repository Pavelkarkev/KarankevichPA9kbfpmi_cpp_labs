...
std::unique_ptr<Lesson> LectureCreator::LessonCreate(size_t auditorynumber,
	std::string& subject,
	std::string& lecturername,
	std::string& dayofweek,
	size_t duration) const {
	return std::make_unique<Lecture>(auditorynumber, subject, lecturername, dayofweek, duration);
}
std::unique_ptr<Lesson> LabCreator::LessonCreate(size_t auditorynumber,
	std::string& subject,
	std::string& lecturername,
	std::string& dayofweek,
	size_t duration) const {
	return std::make_unique<Lab>(auditorynumber, subject, lecturername, dayofweek, duration);
}
std::unique_ptr<Lesson> SeminarCreator::LessonCreate(size_t auditorynumber,
	std::string& subject,
	std::string& lecturername,
	std::string& dayofweek,
	size_t duration) const {
	return std::make_unique<Seminar>(auditorynumber, subject, lecturername, dayofweek, duration);
}
std::unique_ptr<Lesson> Lesson::CreateLesson(const std::string& type,size_t auditorynumber,
	std::string subject,
	std::string lecturername,
	std::string dayofweek,
	size_t duration) {
	...
	if (type == "Seminar") {
		...
		throw std::runtime_error("No instance of an object is found");
	}
}
